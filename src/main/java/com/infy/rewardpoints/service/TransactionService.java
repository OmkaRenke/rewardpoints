...
public interface TransactionService {
	 ...
	 * @throws RewardPointsException if the customer ID is invalid or not found
	 */
	long addTransaction(TransactionDTO transactionDTO, long customerId) throws RewardPointsException;
